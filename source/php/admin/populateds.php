...
require_once(BOOK_ROOT . '/locale/'.$LOCALES[$row]['strings']);
...
$locale->setLOCALE_MENU_FOREWORD($LOCALE_META_TEXT['LOCALE_MENU_FOREWORD']);
...
require_once(BOOK_ROOT . '/locale/'.$LOCALES[$row]['configuration']);
